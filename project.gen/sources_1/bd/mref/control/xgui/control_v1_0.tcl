...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DEFAULT_PCI_BASE" -parent ${Page_0}
...
proc update_PARAM_VALUE.DEFAULT_PCI_BASE { PARAM_VALUE.DEFAULT_PCI_BASE } {
	# Procedure called to update DEFAULT_PCI_BASE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DEFAULT_PCI_BASE { PARAM_VALUE.DEFAULT_PCI_BASE } {
	# Procedure called to validate DEFAULT_PCI_BASE
	return true
}
...
proc update_MODELPARAM_VALUE.DEFAULT_PCI_BASE { MODELPARAM_VALUE.DEFAULT_PCI_BASE PARAM_VALUE.DEFAULT_PCI_BASE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DEFAULT_PCI_BASE}] ${MODELPARAM_VALUE.DEFAULT_PCI_BASE}
}
