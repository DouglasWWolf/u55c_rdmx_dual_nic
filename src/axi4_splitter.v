...
assign S_AXI_ARREADY = (resetn == 1) & (arfifo_in_tready == BOTH);
assign S_AXI_AWREADY = (resetn == 1) & (awfifo_in_tready == BOTH);
assign S_AXI_WREADY  = (resetn == 1) & ( wfifo_in_tready == BOTH);
...
assign S_AXI_RVALID = (resetn == 1) & (rfifo_out_tvalid == BOTH);

// For simplicity, the slave-side RRESP is always "OKAY"
...
//=============================================================================
assign M0_AXI_BREADY = S_AXI_BREADY & (resetn == 1);
assign M1_AXI_BREADY = S_AXI_BREADY & (resetn == 1);
//=============================================================================
...
// B-channel ackowledgement on both of the M_AXI channels.  Every time a 
// acknowledgement arrives on one of the Mn_AXI interfaces, the credit counter
// is incremented.   Every time we send a B-channel acknowledgement on the 
// S_AXI interface, both credit counters are decremented.  
//=============================================================================
wire[1:0] add_credit;
